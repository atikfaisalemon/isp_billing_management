                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input type="number" className="form-control" id="phone" name="phone" value={this.state.phone < 0 ? 0 : this.state.phone} onChange={(e) => this.changeInput(e)} />
                                                </div>
                                            </div>
                                        </div>


                                        <input type="submit" className="btn btn-primary" value={!this.state.isLoading ? "Save" : "Saving..."} disabled={this.state.isLoading} />
                                    </form>
                                </div>
                            </div>
                        </div>
